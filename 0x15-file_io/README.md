...
Tasks 2- a function that appends text at the end of a file.
...
Tasks 4- a program that displays the information contained in the ELF header at the start of an ELF file.
